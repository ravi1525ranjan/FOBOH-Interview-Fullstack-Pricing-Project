...
export default function Header({ onToggleSidenav }: HeaderProps) {
  ...
  return (
    <header
      className="navbar navbar-expand-lg border-bottom px-4"
      style={{ backgroundColor: "#26976C", height: "64px" }}
    >
      <div className="container-fluid d-flex justify-content-between align-items-center py-2">
        ...
        <div className="position-absolute start-50 translate-middle-x">
          <h1 className="h6 mb-0 fw-semibold text-white text-uppercase tracking-wider">
            Pricing Profile
          </h1>
        </div>
